"""
Django settings for BasnyatBrew project.
...
SECRET_KEY = 'django-insecure-@qc5tys7&5#lcs#5y7x(yy1z5sx7m)n^4xwlsuf4h1mr%z*eee'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'backend.context_processors.cart_item_count'
            ],
        },
    },
]

WSGI_APPLICATION = 'BasnyatBrew.wsgi.application'
...
EMAIL_HOST_USER = 'basnyatbrewhub@gmail.com'
EMAIL_HOST_PASSWORD = 'nczj oajh depd ykys'
EMAIL_USE_TLS = True
